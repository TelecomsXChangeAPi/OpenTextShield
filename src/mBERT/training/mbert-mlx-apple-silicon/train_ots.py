...
def main():
    # Detect encoding
    with open('sms_spam_phishing_dataset_v1.7.csv', 'rb') as f:
    ...
    # Load Dataset
    df = pd.read_csv('sms_spam_phishing_dataset_v1.7.csv', encoding=file_encoding)
    ...
    # Save the Model
    torch.save(model.state_dict(), 'mbert_ots_model_1.7.pth')
